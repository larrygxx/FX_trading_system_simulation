...
struct ICurveFXSpot; //Q6
struct ICurveFXForward; //Q8

typedef std::shared_ptr<const ICurve> ptr_curve_t;
typedef std::shared_ptr<const ICurveDiscount> ptr_disc_curve_t;
typedef std::shared_ptr<const ICurveFXSpot> ptr_spot_curve_t; //Q6
typedef std::shared_ptr<const ICurveFXForward> ptr_fwd_curve_t; //Q8
